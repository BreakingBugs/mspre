...
#define PAQUETE_VACIO  {"",0,0,"",0,0,0,0,0,"",""};
 ...
 /**
     * @brief   Agrega la seleccion del cliente al paquete
     * @param  packet: puntero a la estructura del paquete, buf puntero a la cadena del paquete a enviar
     * @return una cadena con el paquete a enviar
     **/   
